...
5. Analyze the results however you want! See [the article](https://innerjoin.bit.io/populating-a-postgresql-table-with-pandas-is-slow-7bc63e9c88dc) for inspiration.
